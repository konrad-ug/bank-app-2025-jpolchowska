...
Scenario: User is able to update name of already created account
    Given Account registry is empty
    And I create an account using name: "Jan", last name: "Nowak", pesel: "90000000001"
    When I update "name" of account with pesel: "90000000001" to "Tomasz"
    Then Account with pesel "90000000001" has "name" equal to "Tomasz"

Scenario: Created account has all fields correctly set
    Given Account registry is empty
    When I create an account using name: "Anna", last name: "Nowak", pesel: "90000000002"
    Then Account with pesel "90000000002" has "name" equal to "Anna"
    And Account with pesel "90000000002" has "surname" equal to "Nowak"
